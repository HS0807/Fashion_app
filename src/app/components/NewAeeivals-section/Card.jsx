...
export default function Card() {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-4 pt-6 justify-items-stretch">
            <figure className="overflow-hidden bg-white w-full min-h-[520px] sm:min-h-[520px] md:min-h-[580px] rounded-[28px] shadow-sm">
